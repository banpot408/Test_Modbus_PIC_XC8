...
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "1" "," "37" "," "128" "," "255" "," "255" "," "255" "," "255" "," "255");
...
void interrupt_isr (void) {
    ...
    if (PIR1bits.RCIF){
        ...
        while (PIR1bits.RCIF){
            ...
            MODBUS.rxtimer=0;
            if(MODBUS.rxcnt>(50 -2)) MODBUS.rxcnt=0;
